---
title: python typer 库使用指南
date: 2022-02-23 09:48:22
tags:
- python
categories:
- 编程
...
`click`是`Argparse`的升级版，而`typer`则是`click`的升级版，其中最大的优势就是可以通过参数的类型识别来快速建立CLI。
...
- [这里](https://typer.tiangolo.com/tutorial/package/)是typer里面提供的打包方法
- [](!poetry-包管理使用方法)
